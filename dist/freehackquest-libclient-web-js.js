// This file was automatically generated by fhq-server (vv0.2.47), date: 2022-01-01 07:29:32
window.fhq = window.fhq || (function() { 
    var self = {};
    self.appName = 'fhq-server';
    self.appVersion = 'v0.2.47';
    self.appBuildDate = '2022-01-01 07:29:32';
    var _lastm = 0;
    var _listeners = {};
   ...
   self.updateUserProfileAsync = function() {
    ...
    self.chats_message_edit = function(params) {
       ...
       // * message_new - string, required (New message) 
        ...
        if (params['message_new'] == undefined) {
    ...
    self.chats_message_send = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.24
    ...
    self.game_info = function(params) {
       ...
       // Access user: yes
       // Access admin: yes
       // Deprecated From Version: 0.2.39
       // Input params:
       // * uuid - string, required (Global Identificator of the Game) 
        params = params || {};
    ...
    self.games_info = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
    ...
    self.games_list = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
        params = params || {};
    ...
    self.quests_files_delete = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Input params:
       ...
       // * file_id - integer, required (File ID) 
        params = params || {};
        params.cmd = 'quests_files.delete';
        if (params['quest_uuid'] == undefined) {
             console.error('Parameter "quest_uuid" expected (lib)');
        }
        if (params['file_id'] == undefined) {
             console.error('Parameter "file_id" expected (lib)');
        }
         return self.send(params);
    }

    self.quests_files_upload = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Input params:
       ...
       // * file_name - string, required (File name) 
        params = params || {};
        params.cmd = 'quests_files.upload';
        if (params['quest_uuid'] == undefined) {
             console.error('Parameter "quest_uuid" expected (lib)');
        }
        if (params['file_base64'] == undefined) {
    ...
    self.quests_user_answer_list = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Input params:
       // * questid - integer, required (Filter for questid) 
        params = params || {};
        params.cmd = 'quests_user_answer_list';
        if (params['questid'] == undefined) {
             console.error('Parameter "questid" expected (lib)');
        }
         return self.send(params);
    ...
    self.useful_links_clicked = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
       ...
       // * useful_link_id - integer, required (Id of useful link) 
        params = params || {};
        params.cmd = 'useful_links_clicked';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
         return self.send(params);
    }

    self.useful_links_comment_add = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * comment - string, required (Comment) 
        params = params || {};
        params.cmd = 'useful_links_comment_add';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
    ...
    self.useful_links_comment_delete = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * useful_link_comment_id - integer, required (Comment Id for useful link) 
        params = params || {};
        params.cmd = 'useful_links_comment_delete';
        if (params['useful_link_comment_id'] == undefined) {
             console.error('Parameter "useful_link_comment_id" expected (lib)');
        }
         return self.send(params);
    }

    self.useful_links_comment_list = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * useful_link_id - integer, required (Id of useful link) 
        params = params || {};
        params.cmd = 'useful_links_comment_list';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
         return self.send(params);
    ...
    self.useful_links_retrieve = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
       ...
       // * useful_link_id - integer, required (Id of useful link) 
        params = params || {};
        params.cmd = 'useful_links_retrieve';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
         return self.send(params);
    ...
    self.useful_links_tag_add = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * tag - string, required (Tag Value) 
        params = params || {};
        params.cmd = 'useful_links_tag_add';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
    ...
    self.useful_links_tag_delete = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * tag - string, required (Tag Value) 
        params = params || {};
        params.cmd = 'useful_links_tag_delete';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
        if (params['tag'] == undefined) {
    ...
    self.useful_links_tag_list = function(params) {
       // Access unauthorized: yes
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
        params = params || {};
        params.cmd = 'useful_links_tag_list';
         return self.send(params);
    }
    ...
    self.useful_links_user_favorite = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * useful_link_id - integer, required (Id of useful link) 
        params = params || {};
        params.cmd = 'useful_links_user_favorite';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
         return self.send(params);
    ...
    self.useful_links_user_favorite_list = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
        params = params || {};
        params.cmd = 'useful_links_user_favorite_list';
         return self.send(params);
    }

    self.useful_links_user_propose = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * tags - string, required (tags) 
        params = params || {};
        params.cmd = 'useful_links_user_propose';
        if (params['url'] == undefined) {
             console.error('Parameter "url" expected (lib)');
        }
        if (params['description'] == undefined) {
    ...
    self.useful_links_user_propose_approve = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * useful_links_propose_id - integer, required (Id of propose for useful_links) 
        params = params || {};
        params.cmd = 'useful_links_user_propose_approve';
        if (params['useful_links_propose_id'] == undefined) {
             console.error('Parameter "useful_links_propose_id" expected (lib)');
        }
         return self.send(params);
    }

    self.useful_links_user_unfavorite = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.29
       ...
       // * useful_link_id - integer, required (Id of useful link) 
        params = params || {};
        params.cmd = 'useful_links_user_unfavorite';
        if (params['useful_link_id'] == undefined) {
             console.error('Parameter "useful_link_id" expected (lib)');
        }
         return self.send(params);
    ...
    self.users_change_email = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Input params:
    ...
    self.users_change_email_verification = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Input params:
       // * code - string, required (Verification code) 
        params = params || {};
        params.cmd = 'users_change_email_verification';
    ...
    self.users_delete = function(params) {
       // Access unauthorized: no
       // Access user: no
       // Access admin: yes
       // Input params:
    ...
    self.users_registration = function(params) {
       // Access unauthorized: yes
       // Access user: no
       // Access admin: no
       // Input params:
    ...
    self.users_registration_verification = function(params) {
       // Access unauthorized: yes
       // Access user: no
       // Access admin: no
       // Input params:
       // * code - string, required (Verification code) 
        params = params || {};
        params.cmd = 'users_registration_verification';
        if (params['code'] == undefined) {
             console.error('Parameter "code" expected (lib)');
        }
         return self.send(params);
    ...
    self.users_tokens = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       // Activated From Version: 0.2.26
        params = params || {};
        params.cmd = 'users_tokens';
         return self.send(params);
    }

    self.users_tokens_delete = function(params) {
       // Access unauthorized: no
       // Access user: yes
       // Access admin: yes
       ...
       // * tokenid - integer, required (Token ID) 
        params = params || {};
        params.cmd = 'users_tokens_delete';
